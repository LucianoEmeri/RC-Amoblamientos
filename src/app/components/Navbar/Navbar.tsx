...
const Logo = () => (
  <motion.div
    ...
    className={`relative w-32 h-16 sm:w-40 sm:h-20 md:w-56 md:h-24 ${textShadowClass}`}
  >
    <Image
      src="/assets/logo.png"
      alt="Logo"
          ...
          <div className="hidden md:flex flex-grow justify-center">
            <div className="flex items-center space-x-1 lg:space-x-6">
              {navItems.map((item) => (
                ...
                >
                  <motion.div
                    className={`relative px-2 py-2 rounded-md text-xs lg:text-sm text-white hover:text-white cursor-pointer transition-all duration-300 ${textShadowClass}`}
                    whileHover="hover"
                  >
                    <motion.span

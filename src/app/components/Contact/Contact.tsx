    ...
    <section id="contact" className="relative">
      ...
      <div className="relative z-10 bg-black bg-opacity-70">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-16">
          ...
          >
            <h2 className={`text-4xl sm:text-5xl font-normal mb-16 text-center text-white ${textShadowClass}`}>CONTÁCTANOS</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            <motion.div
              ...
              className="relative overflow-hidden bg-black bg-opacity-80 border-2 border-opacity-50 border-white p-6 sm:p-8 rounded-lg shadow-lg"
            >
              <div className="absolute inset-0 z-0">
                <Image
                  src="/assets/marquina.jpeg"
              ...
              <div className="relative z-10">
                <h3 className="text-2xl sm:text-3xl font-normal mb-6 sm:mb-8 text-white text-center">NUESTROS LOCALES</h3>
                <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
                  <div className="space-y-3">
                    <p className="flex items-start text-white text-base sm:text-xl">
                  ...
                  <p className="flex items-center text-white text-base sm:text-xl">
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-2xl sm:text-3xl font-normal mb-6 sm:mb-8 text-white text-center">TU CONSULTA</h3>
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                  <div>
                    <label htmlFor="name" className="block text-base sm:text-lg font-medium text-white mb-2">Nombre:</label>
                    <input
                      id="name"
                      type="text"
                      ...
                      required
                      className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-black bg-opacity-20 border border-opacity-50 border-white rounded-lg focus:outline-none focus:ring-2 focus:ring-white text-white placeholder-gray-400 text-base sm:text-lg"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    <label htmlFor="message" className="block text-base sm:text-lg font-medium text-white mb-2">Mensaje:</label>
                    <textarea
                      id="message"
                      rows={5}
                  ...
                  <motion.button
                    type="submit"
                    className="group inline-flex items-center justify-center w-full px-4 sm:px-6 py-2 sm:py-3 text-lg sm:text-xl font-semibold rounded-full bg-white text-black border border-opacity-50 border-white hover:bg-black hover:text-white transition-all duration-300 ease-in-out shadow-md hover:shadow-lg"
                  >
                ...
                {status.message && (
                  <p className={`mt-4 sm:mt-6 text-center text-base sm:text-lg ${status.success ? "text-white" : "text-red-400"}`}>
                    {status.message}
                  </p>
                )}
              </div>

  ...
  return (
    <section id="contact" className="relative">
      ...
      <div className="relative z-10 bg-black bg-opacity-70">
        <div className="container mx-auto px-4 max-w-4xl lg:max-w-7xl py-16">
          <motion.div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            <motion.div
              ...
              className="relative overflow-hidden bg-black bg-opacity-80 border-2 border-opacity-50 border-white p-8 rounded-lg shadow-lg"
            >
              <div className="absolute inset-0 z-0">
                <Image
                  src="/assets/marquina.jpeg"
              ...
              <div className="relative z-10">
                <h3 className="text-3xl font-normal mb-8 text-white text-center">NUESTROS LOCALES</h3>
                <div className="space-y-6 mb-8">
                  <div className="space-y-3">
                    <p className="flex items-start text-white text-xl">
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-3xl font-normal mb-8 text-white text-center">TU CONSULTA</h3>
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <label htmlFor="name" className="block text-lg font-medium text-white mb-2">Nombre:</label>
                    <input
                      id="name"
                      type="text"
                      ...
                      required
                      className="w-full px-4 py-3 bg-black bg-opacity-20 border border-opacity-50 border-white rounded-lg focus:outline-none focus:ring-2 focus:ring-white text-white placeholder-gray-400 text-lg"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    <label htmlFor="message" className="block text-lg font-medium text-white mb-2">Mensaje:</label>
                    <textarea
                      id="message"
                      rows={5}
                  ...
                  <motion.button
                    type="submit"
                    className="group inline-flex items-center justify-center w-full px-6 py-3 text-xl font-semibold rounded-full bg-white text-black border border-opacity-50 border-white hover:bg-black hover:text-white transition-all duration-300 ease-in-out shadow-md hover:shadow-lg"
                  >
                ...
                {status.message && (
                  <p className={`mt-6 text-center text-lg ${status.success ? "text-white" : "text-red-400"}`}>
                    {status.message}
                  </p>
                )}
              </div>
